<?php
//aca los parametros de conexion, preferiblemente configurarla aca mismo
$usuario="root";
$passwd="";
$host="localhost";
$bd="siga";
$fecha=date("d-m-Y");
$nombre=$bd."_".$fecha.".sql"; //Este es el nombre del archivo a generar
...
# +==============================================================================================================
# |
# | Script Hecho por: LMGeeK (Luis Armando Marin)
# | www.allsafe.com.ve      tsuluismarin@gmail.com
# | 
