...
<div class="jumbotron">
    ...
    <input type="button" style="cursor: pointer;" class="btn btn-danger" onclick="javascript:window.history.back();" value="REGRESAR" /> <br><br>
                        ...
                        if(isset($_POST['nacionalidad']) && !empty($_POST['nacionalidad']) &&
                            ...
                            $ced = htmlentities($_POST['cedula1']);
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            <div class="input-group" title="Cedula">
                                ...
                                <?php 
                                    echo "<input name='cedula' type='text' id='cedula' class='form-control' placeholder='Cedula Ejemplo: V-12345678'  required value=".$row2[0]." maxlength='10'/>";
                                 ?>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    ?>
                        ...
                        <form class="form form-signup" role="form" >
                            <div class="form-group">
                                ...
                                <input name="cedula1" type="text" id="cedula" class="form-control" placeholder="Cedula Ejemplo: 12345678" pattern="^[0-9]{7,9}" title="Formato Correcto 12345678 o 9876543" required maxlength="8" />
