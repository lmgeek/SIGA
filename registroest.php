                    ...
                    ?>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="cedula" type="text" id="cedula" class="form-control" placeholder="Cedula Ejemplo: V-12345678" pattern="^[V|E|]\-\d{8}$" title="Formato Correcto V-12345678 o E-12345678 Si la cedula es menor de 10millones colocar de la siguiente forma V-012345678" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                <input name="name" type="text" id="name" class="form-control" placeholder="Nombre y Apellido"  required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="email" type="text" id="email" class="form-control" placeholder="Correo Electronico"  required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-phone-alt"></span></span>
                                <input name="telf1" type="text" id="telf1" class="form-control" placeholder="Telefono Casa"  required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="tlf2" type="text" id="tlf2" class="form-control" placeholder="Telefono Movil"  required/>
                            </div>
                        </div>
