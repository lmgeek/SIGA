...
<html lang="es">
  <head>
    ...
    function abrir(pagina) {
         window.open('constancias2.php','window','width=1000,height=700,scrollbars=yes');
    }
    //-->
    </script>
...
<div class="jumbotron">
    ...
    <input type="button" style="cursor: pointer;" class="btn btn-danger" onclick="javascript:window.history.back();" value="REGRESAR" /> <br><br>
      ...
      <form name="form1" method="post" action="constancias2.php" target="ventanaForm" target="_blank">
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class='alert alert-success-alt alert-success text-center' style='font-size:2em;'>
                          ...
                          <button type='button' class='close' data-dismiss='alert' aria-hidden='true' tittle='Cerrar'>
                              ×</button>Ingrese la Cedula del Estudiante para Imprimir Constancia.
                        </div>

                        <h3 class="text-center">
                            Solicitud de Constancias Estudiantiles</h3>
                        <form class="form form-signup" role="form" >
                            <div class="form-group">
                                ...
                                <input name="cedula" type="text" id="cedula" class="form-control" placeholder="Cedula Ejemplo: 12345678" pattern="^[0-9]{7,9}" title="Formato Correcto 12345678 o 9876543" required max="8" />
                    ...
                    <div class="form-group">
                        <label class="radio-inline">
                          <input type="radio" id="checkboxEnLinea1" name="constancia" value="estudio" checked=""> Constancia de Estudio
                        </label>
                        <label class="radio-inline">
                          <input type="radio" id="checkboxEnLinea2" name="constancia" value="culminacion"> Constancia de Culminaci&oacuten
                        </label>
                    </div>
...
<!--<a href="javascript:void(0)" onclick="window.open('pop/popup.html','','width=700,height=400,noresize')">aaa</a>-->
                    </form>
