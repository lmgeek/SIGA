...
<p style="text-indent: 40px;" align="justify">
Titular de la Cédula de Identidad <b>N° '.$row[0].',</b> es estudiante Regular del Curso <b>'.$row1[1].',</b> en esta Universidad.</p>

<p style="text-indent: 40px;" align="justify">
Constancia que se Expide a peticón de la parte interesada en Santa Ana de Coro, a los '.$dia[date('d')-2].' días del mes de '.$meses[date('n')-1].' del '.$anio.'.</p>
